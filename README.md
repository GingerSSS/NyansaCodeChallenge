...
The idea is
  ...
  2. scan the input by line and store in a linked list
  3. save the input from list to a object to make the sturcture clear, 
     also simple process the timestamp to 'date' (omit time detail)
  4. call the function with an array of object as input, print the result
    (1) map the url with date, url and its hit freq also a map
